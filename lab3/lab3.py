...
degrees = [m for m, _, _ in variances_data]
vars_   = [v for _, v, _ in variances_data]
...
ax3.plot(degrees, vars_, 'bo-', linewidth=2, markersize=7)
ax3.scatter([opt_m], [opt_var], color='red', s=120, zorder=5,
            label=f'Opt m={opt_m}')
ax3.set_xlabel('Poly m')
